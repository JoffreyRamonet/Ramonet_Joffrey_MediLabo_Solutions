...
import {AssessorService} from "../service/assessor-service";
...
export class NewNoteComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private noteService: NoteService, private accessorService: AssessorService, private router: Router, private route: ActivatedRoute) {
  ...
  onSubmitForm(): void {
    ...
    this.noteService.saveNewNote(this.note).pipe(tap(() =>
      this.router.navigateByUrl(`patient/${this.patientId}`)
    )).subscribe();
  }
